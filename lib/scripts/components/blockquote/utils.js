...
export function truncateQuote(quote, maxLength, handler) {
  ...
  return React.createElement(
    'div',
    null,
    quote.length > maxLength ? quote.substr(0, maxLength) + '...' : quote,
    quote.length > maxLength && React.createElement(
      'span',
      { onClick: handler, className: 'blockquote-expand', title: 'Read more', tabIndex: '0' },
      'more'
    )
  );
}
